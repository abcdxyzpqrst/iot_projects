...
def RuLSIF(x_nu, x_de, x_re, alpha, sigma_list,lambda_list, b, fold):
...
def sliding_window(X, windowSize, step):
    ...
    WINDOWS = zeros(num_dims * windowSize * step, floor(num_samples/windowSize/step))
...
def change_point_detection(X, n, k, alpha, fold):
    SCORE = []
